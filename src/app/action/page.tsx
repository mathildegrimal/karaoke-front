...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center p-10 gap-4 text-center">
      <p className="text-xl">
        Hello{" "}
        <b>
          {firstname} {lastname}
      ...
      <div className="flex flex-col items-center justify-between gap-6">
        <div className="flex flex-col gap-2">
          <button
            className="w-24 h-24 rounded-[6px] bg-[#00e5ff] mx-auto items-center"
            onClick={() => {
        ...
        <div className="flex flex-col gap-2">
          <button
            className="w-24 h-24 rounded-[6px] p-6 bg-[#00e5ff] mx-auto items-center"
            onClick={() => {
